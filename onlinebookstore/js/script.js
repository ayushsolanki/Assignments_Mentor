...
myapp.config(function($routeProvider) {
    ...
    .when("/editAuthor", {
        templateUrl: "routes/authordetails.html",
...
myapp.controller('bookStore', function($scope, $http, $location, factoryName) {
    ...
    $scope.AddAuthor = function(emp3) {
       ...
       // var skills = [];
        ...
        if (flag != 1) {
            ...
            var confirmation = confirm("Are you sure you want to add new Author")
	...
	*@ param-{isbn,title,author,price,availableOn}*/
    $scope.AddEmp = function(emp) {
        ...
        if (flag != 1) {
             /* confirmation from the user to insert the data */
            var confirmation = confirm("Are you sure you want to add book")
            if (confirmation == true) {
